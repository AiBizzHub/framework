...
def cast(fieldtype, value=None):
	"""Cast the value to the Python native object of the AiBizzApp fieldtype provided.
	...
	Mapping of Python types => AiBizzApp types:
...
def format_timedelta(o: datetime.timedelta | str) -> str:
	...
	# but AiBizzApp doesn't - I think via babel : only allows 0..23 range for hour
