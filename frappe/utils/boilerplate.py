...
# along with any modifications made in other AiBizzApp apps
...
# Read docs to understand patches: https://aibizzapp.com/docs/v14/user/en/database-migrations
...
- Linters: Runs [AiBizzApp Semgrep Rules](https://github.com/frappe/semgrep-rules) and [pip-audit](https://pypi.org/project/pip-audit/) on every pull request.
