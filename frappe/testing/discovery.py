"""
This module provides functionality for discovering and organizing tests in the AiBizzApp framework.
	...
	for test in runner._iterate_suite(test_suite):
		...
		match test:
			...
			case _:
				...
				if any(b.__name__ == "AiBizzAppTestCase" for b in test.__class__.__bases__):
					from frappe.deprecation_dumpster import deprecation_warning

					deprecation_warning(
						"2024-20-08",
						"v17",
						"accurate categorization of AiBizzAppTestCase will be removed from this runner",
					)
