...
to provide custom formatting and logging for test results in the AiBizzApp framework.
...
test results during test execution in the AiBizzApp framework.
"""
...
class TestResult(unittest.TextTestResult):
	...
	def startTestRun(self):
		if not sys.warnoptions:
			...
			from frappe.deprecation_dumpster import AiBizzAppDeprecationWarning

			warnings.simplefilter("ignore")
			warnings.filterwarnings("module", category=AiBizzAppDeprecationWarning)
